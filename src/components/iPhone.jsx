...
function Model(props) {
  ...
  // Check if materials are loaded before modifying them
  useEffect(() => {
    if (materials) {
      Object.entries(materials).forEach(([materialName, material]) => {
        // Ensure only modify materials that can be changed
        if (
          !["zFdeDaGNRwzccye", "ujsvqBWRMnqdwPx", "hUlRcbieVuIiOXG", "jlzuBkUzuJqgiAK", "xNrofRCqOXXHVZt"].includes(materialName)
        ) {
